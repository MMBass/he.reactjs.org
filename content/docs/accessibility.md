...
תלות בסמן (דרך עכבר או משטח מגע) מובילה להרבה מקרים לא נגישים למשתמשי מקלדת, שכתוצאה מכך לא יוכלו להשתמש באפליקציה.
...
שימו לב שהשילוב בין סוג הדפדפן וקורא המסך חשוב יחסית, ומומלץ לבדוק את האפליקציה בדפדפן המתאים ביותר לקורא המסך שבחרתם.
